module Queue(
  ...
  input  [7:0]  io_enq_bits_scores_0,
  input  [7:0]  io_enq_bits_scores_1,
  input  [7:0]  io_enq_bits_scores_2,
  input  [7:0]  io_enq_bits_scores_3,
  input  [7:0]  io_enq_bits_weights_0,
  input  [7:0]  io_enq_bits_weights_1,
  ...
  output [7:0]  io_deq_bits_scores_0,
  output [7:0]  io_deq_bits_scores_1,
  output [7:0]  io_deq_bits_scores_2,
  output [7:0]  io_deq_bits_scores_3,
  output [7:0]  io_deq_bits_weights_0,
  output [7:0]  io_deq_bits_weights_1,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [7:0] ram_scores_0 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_scores_0_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_scores_0_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  reg [7:0] ram_scores_1 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_scores_1_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_scores_1_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  reg [7:0] ram_scores_2 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_scores_2_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_scores_2_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  reg [7:0] ram_scores_3 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_scores_3_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_scores_3_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  reg [7:0] ram_weights_0 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_weights_0_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_weights_0_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  reg [7:0] ram_weights_1 [0:2]; // @[Decoupled.scala 275:95]
  ...
  wire [7:0] ram_weights_1_io_deq_bits_MPORT_data; // @[Decoupled.scala 275:95]
  wire [7:0] ram_weights_1_MPORT_data; // @[Decoupled.scala 275:95]
  ...
  `else
  assign ram_scores_0_io_deq_bits_MPORT_data = ram_scores_0_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_17[7:0] :
  ...
  `else
  assign ram_scores_1_io_deq_bits_MPORT_data = ram_scores_1_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_19[7:0] :
  ...
  `else
  assign ram_scores_2_io_deq_bits_MPORT_data = ram_scores_2_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_21[7:0] :
  ...
  `else
  assign ram_scores_3_io_deq_bits_MPORT_data = ram_scores_3_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_23[7:0] :
  ...
  `else
  assign ram_weights_0_io_deq_bits_MPORT_data = ram_weights_0_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_25[7:0] :
  ...
  `else
  assign ram_weights_1_io_deq_bits_MPORT_data = ram_weights_1_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_27[7:0] :
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  _RAND_16 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_0[initvar] = _RAND_16[7:0];
  _RAND_18 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_1[initvar] = _RAND_18[7:0];
  _RAND_20 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_2[initvar] = _RAND_20[7:0];
  _RAND_22 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_3[initvar] = _RAND_22[7:0];
  _RAND_24 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_weights_0[initvar] = _RAND_24[7:0];
  _RAND_26 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_weights_1[initvar] = _RAND_26[7:0];
  _RAND_28 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
...
module DispatcherPE(
  ...
  input  [7:0]  io_sample_in_bits_scores_0,
  input  [7:0]  io_sample_in_bits_scores_1,
  input  [7:0]  io_sample_in_bits_scores_2,
  input  [7:0]  io_sample_in_bits_scores_3,
  input  [7:0]  io_sample_in_bits_weights_0,
  input  [7:0]  io_sample_in_bits_weights_1,
  ...
  output [7:0]  io_samples_out_0_bits_scores_0,
  output [7:0]  io_samples_out_0_bits_scores_1,
  output [7:0]  io_samples_out_0_bits_scores_2,
  output [7:0]  io_samples_out_0_bits_scores_3,
  output [7:0]  io_samples_out_0_bits_weights_0,
  output [7:0]  io_samples_out_0_bits_weights_1,
  ...
  output [7:0]  io_samples_out_1_bits_scores_0,
  output [7:0]  io_samples_out_1_bits_scores_1,
  output [7:0]  io_samples_out_1_bits_scores_2,
  output [7:0]  io_samples_out_1_bits_scores_3,
  output [7:0]  io_samples_out_1_bits_weights_0,
  output [7:0]  io_samples_out_1_bits_weights_1
);
  ...
  wire [7:0] queue_io_enq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_enq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_enq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_enq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_enq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_enq_bits_weights_1; // @[Decoupled.scala 377:21]
  ...
  wire [7:0] queue_io_deq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_deq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_deq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_deq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_deq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_io_deq_bits_weights_1; // @[Decoupled.scala 377:21]
...
`endif // RANDOMIZE_REG_INIT
  ...
  assign ram_scores_0_io_deq_bits_MPORT_data = ram_scores_0[ram_scores_0_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_scores_0_io_deq_bits_MPORT_data = ram_scores_0_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_15[7:0] :
    ram_scores_0[ram_scores_0_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_scores_0_MPORT_data = io_enq_bits_scores_0;
  assign ram_scores_0_MPORT_addr = enq_ptr_value;
  ...
  assign ram_scores_1_io_deq_bits_MPORT_data = ram_scores_1[ram_scores_1_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_scores_1_io_deq_bits_MPORT_data = ram_scores_1_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_17[7:0] :
    ram_scores_1[ram_scores_1_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_scores_1_MPORT_data = io_enq_bits_scores_1;
  assign ram_scores_1_MPORT_addr = enq_ptr_value;
  ...
  assign ram_scores_2_io_deq_bits_MPORT_data = ram_scores_2[ram_scores_2_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_scores_2_io_deq_bits_MPORT_data = ram_scores_2_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_19[7:0] :
    ram_scores_2[ram_scores_2_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_scores_2_MPORT_data = io_enq_bits_scores_2;
  assign ram_scores_2_MPORT_addr = enq_ptr_value;
  ...
  assign ram_scores_3_io_deq_bits_MPORT_data = ram_scores_3[ram_scores_3_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_scores_3_io_deq_bits_MPORT_data = ram_scores_3_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_21[7:0] :
    ram_scores_3[ram_scores_3_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_scores_3_MPORT_data = io_enq_bits_scores_3;
  assign ram_scores_3_MPORT_addr = enq_ptr_value;
  ...
  assign ram_weights_0_io_deq_bits_MPORT_data = ram_weights_0[ram_weights_0_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_weights_0_io_deq_bits_MPORT_data = ram_weights_0_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_23[7:0] :
    ram_weights_0[ram_weights_0_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_weights_0_MPORT_data = io_enq_bits_weights_0;
  assign ram_weights_0_MPORT_addr = enq_ptr_value;
  ...
  assign ram_weights_1_io_deq_bits_MPORT_data = ram_weights_1[ram_weights_1_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `else
  assign ram_weights_1_io_deq_bits_MPORT_data = ram_weights_1_io_deq_bits_MPORT_addr >= 2'h3 ? _RAND_25[7:0] :
    ram_weights_1[ram_weights_1_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 275:95]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
  assign ram_weights_1_MPORT_data = io_enq_bits_weights_1;
  assign ram_weights_1_MPORT_addr = enq_ptr_value;
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  _RAND_14 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_0[initvar] = _RAND_14[7:0];
  _RAND_16 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_1[initvar] = _RAND_16[7:0];
  _RAND_18 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_2[initvar] = _RAND_18[7:0];
  _RAND_20 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_scores_3[initvar] = _RAND_20[7:0];
  _RAND_22 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_weights_0[initvar] = _RAND_22[7:0];
  _RAND_24 = {1{`RANDOM}};
  for (initvar = 0; initvar < 3; initvar = initvar+1)
    ram_weights_1[initvar] = _RAND_24[7:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_26 = {1{`RANDOM}};
  enq_ptr_value = _RAND_26[1:0];
  _RAND_27 = {1{`RANDOM}};
  deq_ptr_value = _RAND_27[1:0];
  _RAND_28 = {1{`RANDOM}};
...
module TreePE(
  ...
  output [7:0]  io_sample_out_bits_scores_0,
  output [7:0]  io_sample_out_bits_scores_1,
  output [7:0]  io_sample_out_bits_scores_2,
  output [7:0]  io_sample_out_bits_scores_3,
  output [7:0]  io_sample_out_bits_weights_0,
  output [7:0]  io_sample_out_bits_weights_1
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [19:0] threshold = io_mem_dataOut_1[19:0]; // @[TreePE.scala 30:37]
  ...
  reg [7:0] REG_1_0; // @[TreePE.scala 40:42]
  reg [7:0] REG_1_1; // @[TreePE.scala 40:42]
  reg [7:0] io_sample_out_bits_tree_to_exec_REG; // @[TreePE.scala 41:47]
  reg [7:0] REG_2_0; // @[TreePE.scala 42:41]
  reg [7:0] REG_2_1; // @[TreePE.scala 42:41]
  reg [7:0] REG_2_2; // @[TreePE.scala 42:41]
  reg [7:0] REG_2_3; // @[TreePE.scala 42:41]
  ...
  wire [15:0] _GEN_1 = 2'h1 == attr_id ? features_bits_1 : features_bits_0; // @[TreePE.scala 48:{35,35}]
  wire [15:0] _GEN_2 = 2'h2 == attr_id ? features_bits_2 : _GEN_1; // @[TreePE.scala 48:{35,35}]
  wire [15:0] _GEN_3 = 2'h3 == attr_id ? features_bits_3 : _GEN_2; // @[TreePE.scala 48:{35,35}]
  wire [19:0] _GEN_36 = {{4'd0}, _GEN_3}; // @[TreePE.scala 48:35]
  wire  shift = _GEN_36 < threshold ? leftChildType : rightChildType; // @[TreePE.scala 48:47 49:15 52:15]
  wire [9:0] offset = _GEN_36 < threshold ? leftChildInfo : rightChildInfo; // @[TreePE.scala 48:47 50:16 53:16]
  reg [7:0] io_sample_out_bits_offset_REG; // @[TreePE.scala 56:45]
  reg [7:0] scores_bits_0; // @[TreePE.scala 59:34]
  reg [7:0] scores_bits_1; // @[TreePE.scala 59:34]
  reg [7:0] scores_bits_2; // @[TreePE.scala 59:34]
  reg [7:0] scores_bits_3; // @[TreePE.scala 59:34]
  reg [7:0] weights_bits_0; // @[TreePE.scala 60:35]
  reg [7:0] weights_bits_1; // @[TreePE.scala 60:35]
  wire [7:0] _GEN_7 = 2'h1 == offset[1:0] ? scores_bits_1 : scores_bits_0; // @[TreePE.scala 62:{70,70}]
  wire [7:0] _GEN_8 = 2'h2 == offset[1:0] ? scores_bits_2 : _GEN_7; // @[TreePE.scala 62:{70,70}]
  wire [7:0] _GEN_9 = 2'h3 == offset[1:0] ? scores_bits_3 : _GEN_8; // @[TreePE.scala 62:{70,70}]
  wire [7:0] _GEN_11 = depth_indicator[0] ? weights_bits_1 : weights_bits_0; // @[TreePE.scala 62:{70,70}]
  wire [7:0] _io_sample_out_bits_scores_T_3 = _GEN_9 + _GEN_11; // @[TreePE.scala 62:70]
  wire [7:0] _GEN_12 = 2'h0 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_0; // @[TreePE.scala 42:31 62:{47,47}]
  wire [7:0] _GEN_13 = 2'h1 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_1; // @[TreePE.scala 42:31 62:{47,47}]
  wire [7:0] _GEN_14 = 2'h2 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_2; // @[TreePE.scala 42:31 62:{47,47}]
  wire [7:0] _GEN_15 = 2'h3 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_3; // @[TreePE.scala 42:31 62:{47,47}]
  wire [7:0] _GEN_16 = 2'h0 == offset[1:0] ? _GEN_9 : REG_2_0; // @[TreePE.scala 42:31 64:{47,47}]
  wire [7:0] _GEN_17 = 2'h1 == offset[1:0] ? _GEN_9 : REG_2_1; // @[TreePE.scala 42:31 64:{47,47}]
  wire [7:0] _GEN_18 = 2'h2 == offset[1:0] ? _GEN_9 : REG_2_2; // @[TreePE.scala 42:31 64:{47,47}]
  wire [7:0] _GEN_19 = 2'h3 == offset[1:0] ? _GEN_9 : REG_2_3; // @[TreePE.scala 42:31 64:{47,47}]
  wire [7:0] _GEN_24 = is_valid ? _GEN_12 : _GEN_16; // @[TreePE.scala 61:23]
  wire [7:0] _GEN_25 = is_valid ? _GEN_13 : _GEN_17; // @[TreePE.scala 61:23]
  wire [7:0] _GEN_26 = is_valid ? _GEN_14 : _GEN_18; // @[TreePE.scala 61:23]
  wire [7:0] _GEN_27 = is_valid ? _GEN_15 : _GEN_19; // @[TreePE.scala 61:23]
  reg [7:0] REG_3_0; // @[TreePE.scala 69:45]
  reg [7:0] REG_3_1; // @[TreePE.scala 69:45]
  reg [7:0] REG_3_2; // @[TreePE.scala 69:45]
  reg [7:0] REG_3_3; // @[TreePE.scala 69:45]
  reg  io_sample_out_valid_REG; // @[TreePE.scala 115:35]
  reg  queue_io_deq_ready_REG; // @[TreePE.scala 116:27]
  ...
  assign io_sample_out_valid = io_sample_out_valid_REG; // @[TreePE.scala 115:25]
  ...
  assign io_sample_out_bits_scores_0 = ~shift ? _GEN_24 : REG_3_0; // @[TreePE.scala 55:30 69:35]
  assign io_sample_out_bits_scores_1 = ~shift ? _GEN_25 : REG_3_1; // @[TreePE.scala 55:30 69:35]
  assign io_sample_out_bits_scores_2 = ~shift ? _GEN_26 : REG_3_2; // @[TreePE.scala 55:30 69:35]
  assign io_sample_out_bits_scores_3 = ~shift ? _GEN_27 : REG_3_3; // @[TreePE.scala 55:30 69:35]
  ...
  assign queue_io_enq_bits_weights_0 = io_sample_in_bits_weights_0; // @[Decoupled.scala 380:21]
  assign queue_io_enq_bits_weights_1 = io_sample_in_bits_weights_1; // @[Decoupled.scala 380:21]
  assign queue_io_deq_ready = queue_io_deq_ready_REG; // @[TreePE.scala 116:17]
  always @(posedge clock) begin
    ...
    io_sample_out_valid_REG <= queue_io_deq_valid; // @[TreePE.scala 115:35]
    queue_io_deq_ready_REG <= io_sample_out_ready; // @[TreePE.scala 116:27]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_16 = {1{`RANDOM}};
  scores_bits_0 = _RAND_16[7:0];
  _RAND_17 = {1{`RANDOM}};
  scores_bits_1 = _RAND_17[7:0];
  _RAND_18 = {1{`RANDOM}};
  scores_bits_2 = _RAND_18[7:0];
  _RAND_19 = {1{`RANDOM}};
  scores_bits_3 = _RAND_19[7:0];
  _RAND_20 = {1{`RANDOM}};
  weights_bits_0 = _RAND_20[7:0];
  _RAND_21 = {1{`RANDOM}};
  weights_bits_1 = _RAND_21[7:0];
  _RAND_22 = {1{`RANDOM}};
  REG_3_0 = _RAND_22[7:0];
  _RAND_23 = {1{`RANDOM}};
  REG_3_1 = _RAND_23[7:0];
  _RAND_24 = {1{`RANDOM}};
  REG_3_2 = _RAND_24[7:0];
  _RAND_25 = {1{`RANDOM}};
  REG_3_3 = _RAND_25[7:0];
  _RAND_26 = {1{`RANDOM}};
  io_sample_out_valid_REG = _RAND_26[0:0];
  _RAND_27 = {1{`RANDOM}};
...
module TreePEwithBRAM(
  ...
  input  [7:0]  pe_io_sample_in_bits_scores_0,
  input  [7:0]  pe_io_sample_in_bits_scores_1,
  input  [7:0]  pe_io_sample_in_bits_scores_2,
  input  [7:0]  pe_io_sample_in_bits_scores_3,
  input  [7:0]  pe_io_sample_in_bits_weights_0,
  input  [7:0]  pe_io_sample_in_bits_weights_1,
  ...
  output [7:0]  pe_io_sample_out_bits_scores_0,
  output [7:0]  pe_io_sample_out_bits_scores_1,
  output [7:0]  pe_io_sample_out_bits_scores_2,
  output [7:0]  pe_io_sample_out_bits_scores_3,
  output [7:0]  pe_io_sample_out_bits_weights_0,
  output [7:0]  pe_io_sample_out_bits_weights_1
);
  wire  pe__clock; // @[TreePE.scala 147:18]
  wire  pe__reset; // @[TreePE.scala 147:18]
  wire  pe__io_sample_in_ready; // @[TreePE.scala 147:18]
  wire  pe__io_sample_in_valid; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_in_bits_features_0; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_in_bits_features_1; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_in_bits_features_2; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_in_bits_features_3; // @[TreePE.scala 147:18]
  wire [9:0] pe__io_sample_in_bits_offset; // @[TreePE.scala 147:18]
  wire  pe__io_sample_in_bits_search_for_root; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_tree_to_exec; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_scores_0; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_scores_1; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_scores_2; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_scores_3; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_weights_0; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_in_bits_weights_1; // @[TreePE.scala 147:18]
  wire [9:0] pe__io_mem_addr_1; // @[TreePE.scala 147:18]
  wire [63:0] pe__io_mem_dataOut_1; // @[TreePE.scala 147:18]
  wire  pe__io_sample_out_ready; // @[TreePE.scala 147:18]
  wire  pe__io_sample_out_valid; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_out_bits_features_0; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_out_bits_features_1; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_out_bits_features_2; // @[TreePE.scala 147:18]
  wire [15:0] pe__io_sample_out_bits_features_3; // @[TreePE.scala 147:18]
  wire [9:0] pe__io_sample_out_bits_offset; // @[TreePE.scala 147:18]
  wire  pe__io_sample_out_bits_search_for_root; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_tree_to_exec; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_scores_0; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_scores_1; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_scores_2; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_scores_3; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_weights_0; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_weights_1; // @[TreePE.scala 147:18]
  TreePE pe_ ( // @[TreePE.scala 147:18]
    .clock(pe__clock),
    .reset(pe__reset),
  ...
  assign pe_io_sample_in_ready = pe__io_sample_in_ready; // @[TreePE.scala 149:9]
  assign pe_io_mem_addr_1 = pe__io_mem_addr_1; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_valid = pe__io_sample_out_valid; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_features_0 = pe__io_sample_out_bits_features_0; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_features_1 = pe__io_sample_out_bits_features_1; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_features_2 = pe__io_sample_out_bits_features_2; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_features_3 = pe__io_sample_out_bits_features_3; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_offset = pe__io_sample_out_bits_offset; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_search_for_root = pe__io_sample_out_bits_search_for_root; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_tree_to_exec = pe__io_sample_out_bits_tree_to_exec; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_scores_0 = pe__io_sample_out_bits_scores_0; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_scores_1 = pe__io_sample_out_bits_scores_1; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_scores_2 = pe__io_sample_out_bits_scores_2; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_scores_3 = pe__io_sample_out_bits_scores_3; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_weights_0 = pe__io_sample_out_bits_weights_0; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_weights_1 = pe__io_sample_out_bits_weights_1; // @[TreePE.scala 149:9]
  assign pe__clock = clock;
  assign pe__reset = reset;
  assign pe__io_sample_in_valid = pe_io_sample_in_valid; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_features_0 = pe_io_sample_in_bits_features_0; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_features_1 = pe_io_sample_in_bits_features_1; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_features_2 = pe_io_sample_in_bits_features_2; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_features_3 = pe_io_sample_in_bits_features_3; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_offset = pe_io_sample_in_bits_offset; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_search_for_root = pe_io_sample_in_bits_search_for_root; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_tree_to_exec = pe_io_sample_in_bits_tree_to_exec; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_scores_0 = pe_io_sample_in_bits_scores_0; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_scores_1 = pe_io_sample_in_bits_scores_1; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_scores_2 = pe_io_sample_in_bits_scores_2; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_scores_3 = pe_io_sample_in_bits_scores_3; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_weights_0 = pe_io_sample_in_bits_weights_0; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_weights_1 = pe_io_sample_in_bits_weights_1; // @[TreePE.scala 149:9]
  assign pe__io_mem_dataOut_1 = pe_io_mem_dataOut_1; // @[TreePE.scala 149:9]
  assign pe__io_sample_out_ready = pe_io_sample_out_ready; // @[TreePE.scala 149:9]
endmodule
module TreePE_1(
  input         clock,
  input         reset,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [15:0] _GEN_1 = 2'h1 == attr_id ? features_bits_1 : features_bits_0; // @[TreePE.scala 82:{37,37}]
  wire [15:0] _GEN_2 = 2'h2 == attr_id ? features_bits_2 : _GEN_1; // @[TreePE.scala 82:{37,37}]
  wire [15:0] _GEN_3 = 2'h3 == attr_id ? features_bits_3 : _GEN_2; // @[TreePE.scala 82:{37,37}]
  wire [19:0] _GEN_43 = {{4'd0}, _GEN_3}; // @[TreePE.scala 82:37]
  wire  shift = _GEN_43 < threshold ? leftChildType : rightChildType; // @[TreePE.scala 82:49 83:17 86:17]
  wire [9:0] offset = _GEN_43 < threshold ? leftChildInfo : rightChildInfo; // @[TreePE.scala 82:49 84:18 87:18]
  wire  _T_1 = ~shift; // @[TreePE.scala 89:20]
  reg [7:0] io_sample_out_bits_offset_REG_1; // @[TreePE.scala 90:47]
  reg [7:0] scores_bits_0; // @[TreePE.scala 93:36]
  reg [7:0] scores_bits_1; // @[TreePE.scala 93:36]
  reg [7:0] scores_bits_2; // @[TreePE.scala 93:36]
  reg [7:0] scores_bits_3; // @[TreePE.scala 93:36]
  reg [7:0] weights_bits_0; // @[TreePE.scala 94:37]
  reg [7:0] weights_bits_1; // @[TreePE.scala 94:37]
  wire [7:0] _GEN_7 = 2'h1 == offset[1:0] ? scores_bits_1 : scores_bits_0; // @[TreePE.scala 96:{72,72}]
  wire [7:0] _GEN_8 = 2'h2 == offset[1:0] ? scores_bits_2 : _GEN_7; // @[TreePE.scala 96:{72,72}]
  wire [7:0] _GEN_9 = 2'h3 == offset[1:0] ? scores_bits_3 : _GEN_8; // @[TreePE.scala 96:{72,72}]
  wire [7:0] _GEN_11 = depth_indicator[0] ? weights_bits_1 : weights_bits_0; // @[TreePE.scala 96:{72,72}]
  wire [7:0] _io_sample_out_bits_scores_T_3 = _GEN_9 + _GEN_11; // @[TreePE.scala 96:72]
  wire [7:0] _GEN_12 = 2'h0 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_0; // @[TreePE.scala 42:31 96:{49,49}]
  wire [7:0] _GEN_13 = 2'h1 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_1; // @[TreePE.scala 42:31 96:{49,49}]
  wire [7:0] _GEN_14 = 2'h2 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_2; // @[TreePE.scala 42:31 96:{49,49}]
  wire [7:0] _GEN_15 = 2'h3 == offset[1:0] ? _io_sample_out_bits_scores_T_3 : REG_2_3; // @[TreePE.scala 42:31 96:{49,49}]
  wire [7:0] _GEN_16 = 2'h0 == offset[1:0] ? _GEN_9 : REG_2_0; // @[TreePE.scala 42:31 98:{49,49}]
  wire [7:0] _GEN_17 = 2'h1 == offset[1:0] ? _GEN_9 : REG_2_1; // @[TreePE.scala 42:31 98:{49,49}]
  wire [7:0] _GEN_18 = 2'h2 == offset[1:0] ? _GEN_9 : REG_2_2; // @[TreePE.scala 42:31 98:{49,49}]
  wire [7:0] _GEN_19 = 2'h3 == offset[1:0] ? _GEN_9 : REG_2_3; // @[TreePE.scala 42:31 98:{49,49}]
  wire [7:0] _GEN_24 = is_valid ? _GEN_12 : _GEN_16; // @[TreePE.scala 95:25]
  wire [7:0] _GEN_25 = is_valid ? _GEN_13 : _GEN_17; // @[TreePE.scala 95:25]
  wire [7:0] _GEN_26 = is_valid ? _GEN_14 : _GEN_18; // @[TreePE.scala 95:25]
  wire [7:0] _GEN_27 = is_valid ? _GEN_15 : _GEN_19; // @[TreePE.scala 95:25]
  reg [7:0] REG_4_0; // @[TreePE.scala 102:47]
  reg [7:0] REG_4_1; // @[TreePE.scala 102:47]
  reg [7:0] REG_4_2; // @[TreePE.scala 102:47]
  reg [7:0] REG_4_3; // @[TreePE.scala 102:47]
  wire [9:0] _GEN_28 = ~shift ? {{2'd0}, io_sample_out_bits_offset_REG_1} : offset; // @[TreePE.scala 89:32 101:37 90:37]
  wire [7:0] _GEN_31 = ~shift ? _GEN_24 : REG_4_0; // @[TreePE.scala 89:32 102:37]
  wire [7:0] _GEN_32 = ~shift ? _GEN_25 : REG_4_1; // @[TreePE.scala 89:32 102:37]
  wire [7:0] _GEN_33 = ~shift ? _GEN_26 : REG_4_2; // @[TreePE.scala 89:32 102:37]
  wire [7:0] _GEN_34 = ~shift ? _GEN_27 : REG_4_3; // @[TreePE.scala 89:32 102:37]
  ...
  assign io_sample_out_bits_search_for_root = REG_3 | _T_1; // @[TreePE.scala 74:48 75:44]
  assign io_sample_out_bits_tree_to_exec = io_sample_out_bits_tree_to_exec_REG; // @[TreePE.scala 41:37]
  assign io_sample_out_bits_scores_0 = REG_3 ? REG_2_0 : _GEN_31; // @[TreePE.scala 42:31 74:48]
  assign io_sample_out_bits_scores_1 = REG_3 ? REG_2_1 : _GEN_32; // @[TreePE.scala 42:31 74:48]
  assign io_sample_out_bits_scores_2 = REG_3 ? REG_2_2 : _GEN_33; // @[TreePE.scala 42:31 74:48]
  assign io_sample_out_bits_scores_3 = REG_3 ? REG_2_3 : _GEN_34; // @[TreePE.scala 42:31 74:48]
  assign io_sample_out_bits_weights_0 = REG_1_0; // @[TreePE.scala 40:32]
  assign io_sample_out_bits_weights_1 = REG_1_1; // @[TreePE.scala 40:32]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_18 = {1{`RANDOM}};
  scores_bits_0 = _RAND_18[7:0];
  _RAND_19 = {1{`RANDOM}};
  scores_bits_1 = _RAND_19[7:0];
  _RAND_20 = {1{`RANDOM}};
  scores_bits_2 = _RAND_20[7:0];
  _RAND_21 = {1{`RANDOM}};
  scores_bits_3 = _RAND_21[7:0];
  _RAND_22 = {1{`RANDOM}};
  weights_bits_0 = _RAND_22[7:0];
  _RAND_23 = {1{`RANDOM}};
  weights_bits_1 = _RAND_23[7:0];
  _RAND_24 = {1{`RANDOM}};
  REG_4_0 = _RAND_24[7:0];
  _RAND_25 = {1{`RANDOM}};
  REG_4_1 = _RAND_25[7:0];
  _RAND_26 = {1{`RANDOM}};
  REG_4_2 = _RAND_26[7:0];
  _RAND_27 = {1{`RANDOM}};
  REG_4_3 = _RAND_27[7:0];
  _RAND_28 = {1{`RANDOM}};
  REG_5 = _RAND_28[7:0];
  _RAND_29 = {1{`RANDOM}};
  io_sample_out_valid_REG = _RAND_29[0:0];
  _RAND_30 = {1{`RANDOM}};
  queue_io_deq_ready_REG = _RAND_30[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL
...
module TreePEwithBRAM_1(
  ...
  wire [7:0] pe__io_sample_out_bits_weights_0; // @[TreePE.scala 147:18]
  wire [7:0] pe__io_sample_out_bits_weights_1; // @[TreePE.scala 147:18]
  wire  pe__io_sample_out_bits_dest; // @[TreePE.scala 147:18]
  TreePE_1 pe_ ( // @[TreePE.scala 147:18]
    .clock(pe__clock),
    .reset(pe__reset),
    .io_sample_in_ready(pe__io_sample_in_ready),
    .io_sample_in_valid(pe__io_sample_in_valid),
  ...
  assign pe_io_sample_out_bits_weights_0 = pe__io_sample_out_bits_weights_0; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_weights_1 = pe__io_sample_out_bits_weights_1; // @[TreePE.scala 149:9]
  assign pe_io_sample_out_bits_dest = pe__io_sample_out_bits_dest; // @[TreePE.scala 149:9]
  assign pe__clock = clock;
  assign pe__reset = reset;
  assign pe__io_sample_in_valid = pe_io_sample_in_valid; // @[TreePE.scala 149:9]
  assign pe__io_sample_in_bits_features_0 = pe_io_sample_in_bits_features_0; // @[TreePE.scala 149:9]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  ram_tree_to_exec_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_tree_to_exec_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_scores_0 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_scores_0_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
  ...
  wire  ram_scores_0_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_scores_0_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_scores_1 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_scores_1_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
  ...
  wire  ram_scores_1_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_scores_1_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_scores_2 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_scores_2_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
  ...
  wire  ram_scores_2_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_scores_2_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_scores_3 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_scores_3_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
  ...
  wire  ram_scores_3_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_scores_3_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_weights_0 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_weights_0_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
  ...
  wire  ram_weights_0_MPORT_mask; // @[Decoupled.scala 275:95]
  wire  ram_weights_0_MPORT_en; // @[Decoupled.scala 275:95]
  reg [7:0] ram_weights_1 [0:127]; // @[Decoupled.scala 275:95]
  wire  ram_weights_1_io_deq_bits_MPORT_en; // @[Decoupled.scala 275:95]
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  _RAND_7 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_scores_0[initvar] = _RAND_7[7:0];
  _RAND_8 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_scores_1[initvar] = _RAND_8[7:0];
  _RAND_9 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_scores_2[initvar] = _RAND_9[7:0];
  _RAND_10 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_scores_3[initvar] = _RAND_10[7:0];
  _RAND_11 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_weights_0[initvar] = _RAND_11[7:0];
  _RAND_12 = {1{`RANDOM}};
  for (initvar = 0; initvar < 128; initvar = initvar+1)
    ram_weights_1[initvar] = _RAND_12[7:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_13 = {1{`RANDOM}};
  enq_ptr_value = _RAND_13[6:0];
  _RAND_14 = {1{`RANDOM}};
  deq_ptr_value = _RAND_14[6:0];
  _RAND_15 = {1{`RANDOM}};
...
module FirstInterconnectPE(
  ...
  input  [7:0]  io_sample_entering_bits_scores_0,
  input  [7:0]  io_sample_entering_bits_scores_1,
  input  [7:0]  io_sample_entering_bits_scores_2,
  input  [7:0]  io_sample_entering_bits_scores_3,
  input  [7:0]  io_sample_entering_bits_weights_0,
  input  [7:0]  io_sample_entering_bits_weights_1,
  ...
  input  [7:0]  io_sample_looping_bits_scores_0,
  input  [7:0]  io_sample_looping_bits_scores_1,
  input  [7:0]  io_sample_looping_bits_scores_2,
  input  [7:0]  io_sample_looping_bits_scores_3,
  input  [7:0]  io_sample_looping_bits_weights_0,
  input  [7:0]  io_sample_looping_bits_weights_1,
  input         io_sample_out_ready,
  output        io_sample_out_valid,
  output [15:0] io_sample_out_bits_features_0,
  output [15:0] io_sample_out_bits_features_1,
  ...
  wire [7:0] queue_entering_io_enq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_enq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_enq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_enq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_enq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_enq_bits_weights_1; // @[Decoupled.scala 377:21]
  ...
  wire [7:0] queue_entering_io_deq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_deq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_deq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_deq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_deq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_entering_io_deq_bits_weights_1; // @[Decoupled.scala 377:21]
  ...
  wire [7:0] queue_looping_io_enq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_enq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_enq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_enq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_enq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_enq_bits_weights_1; // @[Decoupled.scala 377:21]
  ...
  wire [7:0] queue_looping_io_deq_bits_scores_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_deq_bits_scores_1; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_deq_bits_scores_2; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_deq_bits_scores_3; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_deq_bits_weights_0; // @[Decoupled.scala 377:21]
  wire [7:0] queue_looping_io_deq_bits_weights_1; // @[Decoupled.scala 377:21]
  ...
  wire [7:0] _GEN_8 = queue_entering_io_deq_bits_scores_0; // @[Interconnect.scala 70:37 71:28 76:28]
  wire [7:0] _GEN_9 = queue_entering_io_deq_bits_scores_1; // @[Interconnect.scala 70:37 71:28 76:28]
  wire [7:0] _GEN_10 = queue_entering_io_deq_bits_scores_2; // @[Interconnect.scala 70:37 71:28 76:28]
  wire [7:0] _GEN_11 = queue_entering_io_deq_bits_scores_3; // @[Interconnect.scala 70:37 71:28 76:28]
  wire [7:0] _GEN_12 = queue_entering_io_deq_bits_weights_0; // @[Interconnect.scala 70:37 71:28 76:28]
  wire [7:0] _GEN_13 = queue_entering_io_deq_bits_weights_1; // @[Interconnect.scala 70:37 71:28 76:28]
  wire  _GEN_15 = queue_entering_io_deq_valid; // @[Interconnect.scala 70:37 72:29 77:29]
  wire  _GEN_16 = queue_entering_io_deq_valid ? io_sample_out_ready : 1'h1; // @[Interconnect.scala 70:37 73:30 79:30]
  Queue_3 queue_entering ( // @[Decoupled.scala 377:21]
  ...
  Queue_3 queue_looping ( // @[Decoupled.scala 377:21]
  ...
  assign io_sample_out_valid = queue_looping_io_deq_valid | _GEN_15; // @[Interconnect.scala 65:30 67:29]
  assign io_sample_out_bits_features_0 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_features_0 : _GEN_0; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_features_1 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_features_1 : _GEN_1; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_features_2 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_features_2 : _GEN_2; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_features_3 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_features_3 : _GEN_3; // @[Interconnect.scala 65:30 66:28]
  ...
  assign io_sample_out_bits_scores_0 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_scores_0 : _GEN_8; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_scores_1 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_scores_1 : _GEN_9; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_scores_2 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_scores_2 : _GEN_10; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_scores_3 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_scores_3 : _GEN_11; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_weights_0 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_weights_0 : _GEN_12; // @[Interconnect.scala 65:30 66:28]
  assign io_sample_out_bits_weights_1 = queue_looping_io_deq_valid ? queue_looping_io_deq_bits_weights_1 : _GEN_13; // @[Interconnect.scala 65:30 66:28]
  ...
  assign queue_entering_io_deq_ready = queue_looping_io_deq_valid ? 1'h0 : _GEN_16; // @[Interconnect.scala 65:30 69:30]
...
module LastInterconnectPE(
  ...
  output [7:0]  io_sample_looping_bits_scores_0,
  output [7:0]  io_sample_looping_bits_scores_1,
  output [7:0]  io_sample_looping_bits_scores_2,
  output [7:0]  io_sample_looping_bits_scores_3,
  output [7:0]  io_sample_looping_bits_weights_0,
  output [7:0]  io_sample_looping_bits_weights_1,
  ...
  output [7:0]  io_sample_leaving_bits_scores_0,
  output [7:0]  io_sample_leaving_bits_scores_1,
  output [7:0]  io_sample_leaving_bits_scores_2,
  output [7:0]  io_sample_leaving_bits_scores_3,
  output [7:0]  io_sample_leaving_bits_weights_0,
  output [7:0]  io_sample_leaving_bits_weights_1,
  output        io_sample_leaving_bits_dest
);
  wire  queue_clock; // @[Decoupled.scala 377:21]
  wire  queue_reset; // @[Decoupled.scala 377:21]
  wire  queue_io_enq_ready; // @[Decoupled.scala 377:21]
  ...
  assign io_sample_leaving_bits_dest = queue_io_deq_bits_dest; // @[Interconnect.scala 17:28]
  assign queue_clock = clock;
  assign queue_reset = reset;
  assign queue_io_enq_valid = io_sample_in_valid; // @[Decoupled.scala 379:22]
  assign queue_io_enq_bits_features_0 = io_sample_in_bits_features_0; // @[Decoupled.scala 380:21]
...
module IncrementTreePE(
  ...
  assign io_sample_in_ready = queue_io_enq_ready; // @[Decoupled.scala 381:17]
  assign io_sample_out_valid = queue_io_deq_valid; // @[IncrementTreePE.scala 24:25]
  ...
  assign queue_io_enq_bits_weights_0 = io_sample_in_bits_weights_0; // @[Decoupled.scala 380:21]
  assign queue_io_enq_bits_weights_1 = io_sample_in_bits_weights_1; // @[Decoupled.scala 380:21]
  assign queue_io_deq_ready = io_sample_out_ready; // @[IncrementTreePE.scala 26:17]
endmodule
module TreePEsWrapper(
  ...
  input  [15:0] wrapper_io_sample_in_bits_features_0,
  input  [15:0] wrapper_io_sample_in_bits_features_1,
  input  [15:0] wrapper_io_sample_in_bits_features_2,
  input  [15:0] wrapper_io_sample_in_bits_features_3,
  input  [9:0]  wrapper_io_sample_in_bits_offset,
  input         wrapper_io_sample_in_bits_shift,
  input         wrapper_io_sample_in_bits_search_for_root,
  input  [7:0]  wrapper_io_sample_in_bits_tree_to_exec,
  input  [7:0]  wrapper_io_sample_in_bits_scores_0,
  input  [7:0]  wrapper_io_sample_in_bits_scores_1,
  input  [7:0]  wrapper_io_sample_in_bits_scores_2,
  input  [7:0]  wrapper_io_sample_in_bits_scores_3,
  input  [7:0]  wrapper_io_sample_in_bits_weights_0,
  input  [7:0]  wrapper_io_sample_in_bits_weights_1,
  input         wrapper_io_sample_in_bits_dest,
  input         wrapper_io_sample_out_0_ready,
  output        wrapper_io_sample_out_0_valid,
  output [15:0] wrapper_io_sample_out_0_bits_features_0,
  output [15:0] wrapper_io_sample_out_0_bits_features_1,
  output [15:0] wrapper_io_sample_out_0_bits_features_2,
  output [15:0] wrapper_io_sample_out_0_bits_features_3,
  output [9:0]  wrapper_io_sample_out_0_bits_offset,
  output        wrapper_io_sample_out_0_bits_shift,
  output        wrapper_io_sample_out_0_bits_search_for_root,
  output [7:0]  wrapper_io_sample_out_0_bits_tree_to_exec,
  output [7:0]  wrapper_io_sample_out_0_bits_scores_0,
  output [7:0]  wrapper_io_sample_out_0_bits_scores_1,
  output [7:0]  wrapper_io_sample_out_0_bits_scores_2,
  output [7:0]  wrapper_io_sample_out_0_bits_scores_3,
  output [7:0]  wrapper_io_sample_out_0_bits_weights_0,
  output [7:0]  wrapper_io_sample_out_0_bits_weights_1,
  output        wrapper_io_sample_out_0_bits_dest,
  input         wrapper_io_sample_out_1_ready,
  output        wrapper_io_sample_out_1_valid,
  output [15:0] wrapper_io_sample_out_1_bits_features_0,
  output [15:0] wrapper_io_sample_out_1_bits_features_1,
  output [15:0] wrapper_io_sample_out_1_bits_features_2,
  output [15:0] wrapper_io_sample_out_1_bits_features_3,
  output [9:0]  wrapper_io_sample_out_1_bits_offset,
  output        wrapper_io_sample_out_1_bits_shift,
  output        wrapper_io_sample_out_1_bits_search_for_root,
  output [7:0]  wrapper_io_sample_out_1_bits_tree_to_exec,
  output [7:0]  wrapper_io_sample_out_1_bits_scores_0,
  output [7:0]  wrapper_io_sample_out_1_bits_scores_1,
  output [7:0]  wrapper_io_sample_out_1_bits_scores_2,
  output [7:0]  wrapper_io_sample_out_1_bits_scores_3,
  output [7:0]  wrapper_io_sample_out_1_bits_weights_0,
  output [7:0]  wrapper_io_sample_out_1_bits_weights_1,
  output        wrapper_io_sample_out_1_bits_dest,
  output        wrapper_io_brams_0_enable_1,
  output        wrapper_io_brams_0_write_1,
  output [9:0]  wrapper_io_brams_0_addr_1,
  output [63:0] wrapper_io_brams_0_dataIn_1,
  input  [63:0] wrapper_io_brams_0_dataOut_1,
  output        wrapper_io_brams_0_enable_2,
  output        wrapper_io_brams_0_write_2,
  output [9:0]  wrapper_io_brams_0_addr_2,
  output [63:0] wrapper_io_brams_0_dataIn_2,
  input  [63:0] wrapper_io_brams_0_dataOut_2,
  output        wrapper_io_brams_1_enable_1,
  output        wrapper_io_brams_1_write_1,
  output [9:0]  wrapper_io_brams_1_addr_1,
  output [63:0] wrapper_io_brams_1_dataIn_1,
  input  [63:0] wrapper_io_brams_1_dataOut_1,
  output        wrapper_io_brams_1_enable_2,
  output        wrapper_io_brams_1_write_2,
  output [9:0]  wrapper_io_brams_1_addr_2,
  output [63:0] wrapper_io_brams_1_dataIn_2,
  input  [63:0] wrapper_io_brams_1_dataOut_2,
  output        wrapper_io_brams_2_enable_1,
  output        wrapper_io_brams_2_write_1,
  output [9:0]  wrapper_io_brams_2_addr_1,
  output [63:0] wrapper_io_brams_2_dataIn_1,
  input  [63:0] wrapper_io_brams_2_dataOut_1,
  output        wrapper_io_brams_2_enable_2,
  output        wrapper_io_brams_2_write_2,
  output [9:0]  wrapper_io_brams_2_addr_2,
  output [63:0] wrapper_io_brams_2_dataIn_2,
  input  [63:0] wrapper_io_brams_2_dataOut_2,
  output        wrapper_io_brams_3_enable_1,
  output        wrapper_io_brams_3_write_1,
  output [9:0]  wrapper_io_brams_3_addr_1,
  output [63:0] wrapper_io_brams_3_dataIn_1,
  input  [63:0] wrapper_io_brams_3_dataOut_1,
  output        wrapper_io_brams_3_enable_2,
  output        wrapper_io_brams_3_write_2,
  output [9:0]  wrapper_io_brams_3_addr_2,
  output [63:0] wrapper_io_brams_3_dataIn_2,
  input  [63:0] wrapper_io_brams_3_dataOut_2,
  ...
  wire  dispatcher_clock; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_reset; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_sample_in_ready; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_sample_in_valid; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 46:28]
  wire [9:0] dispatcher_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_sample_in_bits_shift; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_sample_in_bits_dest; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_samples_out_0_ready; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_samples_out_0_valid; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_0_bits_features_0; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_0_bits_features_1; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_0_bits_features_2; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_0_bits_features_3; // @[TreePEsWrapper.scala 46:28]
  wire [9:0] dispatcher_io_samples_out_0_bits_offset; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_samples_out_0_bits_search_for_root; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_tree_to_exec; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_scores_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_scores_1; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_scores_2; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_scores_3; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_weights_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_0_bits_weights_1; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_samples_out_1_valid; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_1_bits_features_0; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_1_bits_features_1; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_1_bits_features_2; // @[TreePEsWrapper.scala 46:28]
  wire [15:0] dispatcher_io_samples_out_1_bits_features_3; // @[TreePEsWrapper.scala 46:28]
  wire [9:0] dispatcher_io_samples_out_1_bits_offset; // @[TreePEsWrapper.scala 46:28]
  wire  dispatcher_io_samples_out_1_bits_search_for_root; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_tree_to_exec; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_scores_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_scores_1; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_scores_2; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_scores_3; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_weights_0; // @[TreePEsWrapper.scala 46:28]
  wire [7:0] dispatcher_io_samples_out_1_bits_weights_1; // @[TreePEsWrapper.scala 46:28]
  wire  pes_0_clock; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_reset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_in_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_in_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_pe_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 52:65]
  wire [63:0] pes_0_pe_io_mem_dataOut_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_out_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_out_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_pe_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_pe_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_pe_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_pe_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_clock; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_reset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_in_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_in_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_pe_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 52:65]
  wire [63:0] pes_1_pe_io_mem_dataOut_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_out_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_out_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_pe_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_pe_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_pe_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_pe_io_sample_out_bits_dest; // @[TreePEsWrapper.scala 52:65]
  wire  brams_0_clock; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_0_io_addr_1; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_io_dataOut_1; // @[TreePEsWrapper.scala 53:67]
  wire  brams_0_io_enable_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_0_io_write_2; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_0_io_addr_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_io_dataIn_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_io_dataOut_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_clock; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_1_io_addr_1; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_io_dataOut_1; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_io_enable_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_io_write_2; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_1_io_addr_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_io_dataIn_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_io_dataOut_2; // @[TreePEsWrapper.scala 53:67]
  wire  first_interconnects_0_clock; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_reset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_entering_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_entering_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_entering_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_entering_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_entering_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_entering_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_0_io_sample_entering_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_entering_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_entering_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_looping_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_looping_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_looping_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_looping_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_looping_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_looping_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_0_io_sample_looping_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_looping_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_looping_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_out_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_out_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_0_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_0_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_0_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_0_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  last_interconnect_clock; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_reset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_in_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_in_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_in_bits_dest; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_looping_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_looping_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_looping_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_looping_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_looping_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_looping_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_io_sample_looping_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_looping_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_looping_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_leaving_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_leaving_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_leaving_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_leaving_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_leaving_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_io_sample_leaving_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_io_sample_leaving_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_leaving_bits_shift; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_leaving_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_io_sample_leaving_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_io_sample_leaving_bits_dest; // @[TreePEsWrapper.scala 55:39]
  wire  increment_clock; // @[TreePEsWrapper.scala 56:31]
  wire  increment_reset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_in_ready; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_in_valid; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 56:31]
  wire [9:0] increment_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_out_ready; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_out_valid; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 56:31]
  wire [9:0] increment_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 56:31]
  wire  pes_0_1_clock; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_reset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_in_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_in_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_1_pe_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 52:65]
  wire [63:0] pes_0_1_pe_io_mem_dataOut_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_out_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_out_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_0_1_pe_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_0_1_pe_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_0_1_pe_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_0_1_pe_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_clock; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_reset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_in_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_in_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_1_pe_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 52:65]
  wire [63:0] pes_1_1_pe_io_mem_dataOut_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_out_ready; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_out_valid; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 52:65]
  wire [15:0] pes_1_1_pe_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 52:65]
  wire [9:0] pes_1_1_pe_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 52:65]
  wire [7:0] pes_1_1_pe_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 52:65]
  wire  pes_1_1_pe_io_sample_out_bits_dest; // @[TreePEsWrapper.scala 52:65]
  wire  brams_0_1_clock; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_0_1_io_addr_1; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_1_io_dataOut_1; // @[TreePEsWrapper.scala 53:67]
  wire  brams_0_1_io_enable_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_0_1_io_write_2; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_0_1_io_addr_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_1_io_dataIn_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_0_1_io_dataOut_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_1_clock; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_1_1_io_addr_1; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_1_io_dataOut_1; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_1_io_enable_2; // @[TreePEsWrapper.scala 53:67]
  wire  brams_1_1_io_write_2; // @[TreePEsWrapper.scala 53:67]
  wire [9:0] brams_1_1_io_addr_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_1_io_dataIn_2; // @[TreePEsWrapper.scala 53:67]
  wire [63:0] brams_1_1_io_dataOut_2; // @[TreePEsWrapper.scala 53:67]
  wire  first_interconnects_1_clock; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_reset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_entering_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_entering_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_entering_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_entering_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_entering_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_entering_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_1_io_sample_entering_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_entering_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_entering_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_looping_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_looping_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_looping_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_looping_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_looping_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_looping_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_1_io_sample_looping_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_looping_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_looping_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_out_ready; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_out_valid; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 54:40]
  wire [15:0] first_interconnects_1_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 54:40]
  wire [9:0] first_interconnects_1_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 54:40]
  wire  first_interconnects_1_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 54:40]
  wire [7:0] first_interconnects_1_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 54:40]
  wire  last_interconnect_1_clock; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_reset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_in_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_in_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_1_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_in_bits_dest; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_looping_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_looping_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_looping_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_looping_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_looping_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_looping_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_1_io_sample_looping_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_looping_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_looping_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_leaving_ready; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_leaving_valid; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_leaving_bits_features_0; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_leaving_bits_features_1; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_leaving_bits_features_2; // @[TreePEsWrapper.scala 55:39]
  wire [15:0] last_interconnect_1_io_sample_leaving_bits_features_3; // @[TreePEsWrapper.scala 55:39]
  wire [9:0] last_interconnect_1_io_sample_leaving_bits_offset; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_leaving_bits_shift; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_leaving_bits_search_for_root; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_tree_to_exec; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_scores_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_scores_1; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_scores_2; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_scores_3; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_weights_0; // @[TreePEsWrapper.scala 55:39]
  wire [7:0] last_interconnect_1_io_sample_leaving_bits_weights_1; // @[TreePEsWrapper.scala 55:39]
  wire  last_interconnect_1_io_sample_leaving_bits_dest; // @[TreePEsWrapper.scala 55:39]
  wire  increment_1_clock; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_reset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_in_ready; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_in_valid; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 56:31]
  wire [9:0] increment_1_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_out_ready; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_out_valid; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_out_bits_features_0; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_out_bits_features_1; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_out_bits_features_2; // @[TreePEsWrapper.scala 56:31]
  wire [15:0] increment_1_io_sample_out_bits_features_3; // @[TreePEsWrapper.scala 56:31]
  wire [9:0] increment_1_io_sample_out_bits_offset; // @[TreePEsWrapper.scala 56:31]
  wire  increment_1_io_sample_out_bits_search_for_root; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_tree_to_exec; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_scores_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_scores_1; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_scores_2; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_scores_3; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_weights_0; // @[TreePEsWrapper.scala 56:31]
  wire [7:0] increment_1_io_sample_out_bits_weights_1; // @[TreePEsWrapper.scala 56:31]
  DispatcherPE dispatcher ( // @[TreePEsWrapper.scala 46:28]
    ...
    .io_sample_in_bits_dest(dispatcher_io_sample_in_bits_dest),
  ...
  TreePEwithBRAM pes_0 ( // @[TreePEsWrapper.scala 52:65]
    .clock(pes_0_clock),
    .reset(pes_0_reset),
  ...
  TreePEwithBRAM_1 pes_1 ( // @[TreePEsWrapper.scala 52:65]
    .clock(pes_1_clock),
    .reset(pes_1_reset),
  ...
  BRAMLikeMem1 brams_0 ( // @[TreePEsWrapper.scala 53:67]
    .clock(brams_0_clock),
  ...
  BRAMLikeMem1 brams_1 ( // @[TreePEsWrapper.scala 53:67]
    .clock(brams_1_clock),
  ...
  FirstInterconnectPE first_interconnects_0 ( // @[TreePEsWrapper.scala 54:40]
  ...
  LastInterconnectPE last_interconnect ( // @[TreePEsWrapper.scala 55:39]
    ...
    .io_sample_leaving_bits_dest(last_interconnect_io_sample_leaving_bits_dest)
  );
  IncrementTreePE increment ( // @[TreePEsWrapper.scala 56:31]
  ...
  TreePEwithBRAM pes_0_1 ( // @[TreePEsWrapper.scala 52:65]
    .clock(pes_0_1_clock),
    .reset(pes_0_1_reset),
  ...
  TreePEwithBRAM_1 pes_1_1 ( // @[TreePEsWrapper.scala 52:65]
    .clock(pes_1_1_clock),
    .reset(pes_1_1_reset),
  ...
  BRAMLikeMem1 brams_0_1 ( // @[TreePEsWrapper.scala 53:67]
  ...
  BRAMLikeMem1 brams_1_1 ( // @[TreePEsWrapper.scala 53:67]
  ...
  FirstInterconnectPE first_interconnects_1 ( // @[TreePEsWrapper.scala 54:40]
  ...
  LastInterconnectPE last_interconnect_1 ( // @[TreePEsWrapper.scala 55:39]
    ...
    .io_sample_leaving_bits_dest(last_interconnect_1_io_sample_leaving_bits_dest)
  );
  IncrementTreePE increment_1 ( // @[TreePEsWrapper.scala 56:31]
  ...
  assign wrapper_io_sample_in_ready = dispatcher_io_sample_in_ready; // @[TreePEsWrapper.scala 112:26]
  assign wrapper_io_sample_out_0_valid = last_interconnect_io_sample_leaving_valid; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_features_0 = last_interconnect_io_sample_leaving_bits_features_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_features_1 = last_interconnect_io_sample_leaving_bits_features_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_features_2 = last_interconnect_io_sample_leaving_bits_features_2; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_features_3 = last_interconnect_io_sample_leaving_bits_features_3; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_offset = last_interconnect_io_sample_leaving_bits_offset; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_shift = last_interconnect_io_sample_leaving_bits_shift; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_search_for_root = last_interconnect_io_sample_leaving_bits_search_for_root; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_tree_to_exec = last_interconnect_io_sample_leaving_bits_tree_to_exec; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_scores_0 = last_interconnect_io_sample_leaving_bits_scores_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_scores_1 = last_interconnect_io_sample_leaving_bits_scores_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_scores_2 = last_interconnect_io_sample_leaving_bits_scores_2; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_scores_3 = last_interconnect_io_sample_leaving_bits_scores_3; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_weights_0 = last_interconnect_io_sample_leaving_bits_weights_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_weights_1 = last_interconnect_io_sample_leaving_bits_weights_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_0_bits_dest = last_interconnect_io_sample_leaving_bits_dest; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_valid = last_interconnect_1_io_sample_leaving_valid; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_features_0 = last_interconnect_1_io_sample_leaving_bits_features_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_features_1 = last_interconnect_1_io_sample_leaving_bits_features_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_features_2 = last_interconnect_1_io_sample_leaving_bits_features_2; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_features_3 = last_interconnect_1_io_sample_leaving_bits_features_3; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_offset = last_interconnect_1_io_sample_leaving_bits_offset; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_shift = last_interconnect_1_io_sample_leaving_bits_shift; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_search_for_root = last_interconnect_1_io_sample_leaving_bits_search_for_root; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_tree_to_exec = last_interconnect_1_io_sample_leaving_bits_tree_to_exec; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_scores_0 = last_interconnect_1_io_sample_leaving_bits_scores_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_scores_1 = last_interconnect_1_io_sample_leaving_bits_scores_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_scores_2 = last_interconnect_1_io_sample_leaving_bits_scores_2; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_scores_3 = last_interconnect_1_io_sample_leaving_bits_scores_3; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_weights_0 = last_interconnect_1_io_sample_leaving_bits_weights_0; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_weights_1 = last_interconnect_1_io_sample_leaving_bits_weights_1; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_sample_out_1_bits_dest = last_interconnect_1_io_sample_leaving_bits_dest; // @[TreePEsWrapper.scala 89:45]
  assign wrapper_io_brams_0_enable_1 = 1'h1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_write_1 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_addr_1 = pes_0_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_dataIn_1 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_enable_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_write_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_addr_2 = 10'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_0_dataIn_2 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_enable_1 = 1'h1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_write_1 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_addr_1 = pes_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_dataIn_1 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_enable_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_write_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_addr_2 = 10'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_1_dataIn_2 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_enable_1 = 1'h1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_write_1 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_addr_1 = pes_0_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_dataIn_1 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_enable_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_write_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_addr_2 = 10'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_2_dataIn_2 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_enable_1 = 1'h1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_write_1 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_addr_1 = pes_1_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_dataIn_1 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_enable_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_write_2 = 1'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_addr_2 = 10'h0; // @[TreePEsWrapper.scala 59:39]
  assign wrapper_io_brams_3_dataIn_2 = 64'h0; // @[TreePEsWrapper.scala 59:39]
  assign brams_io_0_dataOut_1 = 64'h0; // @[TreePEsWrapper.scala 73:41]
  assign brams_io_0_dataOut_2 = brams_0_io_dataOut_2; // @[TreePEsWrapper.scala 71:41]
  assign brams_io_1_dataOut_1 = 64'h0; // @[TreePEsWrapper.scala 73:41]
  assign brams_io_1_dataOut_2 = brams_1_io_dataOut_2; // @[TreePEsWrapper.scala 71:41]
  assign brams_io_2_dataOut_1 = 64'h0; // @[TreePEsWrapper.scala 73:41]
  assign brams_io_2_dataOut_2 = brams_0_1_io_dataOut_2; // @[TreePEsWrapper.scala 71:41]
  assign brams_io_3_dataOut_1 = 64'h0; // @[TreePEsWrapper.scala 73:41]
  assign brams_io_3_dataOut_2 = brams_1_1_io_dataOut_2; // @[TreePEsWrapper.scala 71:41]
  assign dispatcher_clock = clock;
  assign dispatcher_reset = reset;
  assign dispatcher_io_sample_in_valid = wrapper_io_sample_in_valid; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_features_0 = wrapper_io_sample_in_bits_features_0; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_features_1 = wrapper_io_sample_in_bits_features_1; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_features_2 = wrapper_io_sample_in_bits_features_2; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_features_3 = wrapper_io_sample_in_bits_features_3; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_offset = wrapper_io_sample_in_bits_offset; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_shift = wrapper_io_sample_in_bits_shift; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_search_for_root = wrapper_io_sample_in_bits_search_for_root; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_tree_to_exec = wrapper_io_sample_in_bits_tree_to_exec; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_scores_0 = wrapper_io_sample_in_bits_scores_0; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_scores_1 = wrapper_io_sample_in_bits_scores_1; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_scores_2 = wrapper_io_sample_in_bits_scores_2; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_scores_3 = wrapper_io_sample_in_bits_scores_3; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_weights_0 = wrapper_io_sample_in_bits_weights_0; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_weights_1 = wrapper_io_sample_in_bits_weights_1; // @[TreePEsWrapper.scala 112:26]
  assign dispatcher_io_sample_in_bits_dest = wrapper_io_sample_in_bits_dest; // @[TreePEsWrapper.scala 112:26]
  ...
  assign pes_0_pe_io_mem_dataOut_1 = brams_0_io_dataOut_1; // @[TreePEsWrapper.scala 65:40]
  assign pes_0_pe_io_sample_out_ready = pes_1_pe_io_sample_in_ready; // @[TreePE.scala 156:22]
  assign pes_1_clock = clock;
  assign pes_1_reset = reset;
  assign pes_1_pe_io_sample_in_valid = pes_0_pe_io_sample_out_valid; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_features_0 = pes_0_pe_io_sample_out_bits_features_0; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_features_1 = pes_0_pe_io_sample_out_bits_features_1; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_features_2 = pes_0_pe_io_sample_out_bits_features_2; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_features_3 = pes_0_pe_io_sample_out_bits_features_3; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_offset = pes_0_pe_io_sample_out_bits_offset; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_search_for_root = pes_0_pe_io_sample_out_bits_search_for_root; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_tree_to_exec = pes_0_pe_io_sample_out_bits_tree_to_exec; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_scores_0 = pes_0_pe_io_sample_out_bits_scores_0; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_scores_1 = pes_0_pe_io_sample_out_bits_scores_1; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_scores_2 = pes_0_pe_io_sample_out_bits_scores_2; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_scores_3 = pes_0_pe_io_sample_out_bits_scores_3; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_weights_0 = pes_0_pe_io_sample_out_bits_weights_0; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_sample_in_bits_weights_1 = pes_0_pe_io_sample_out_bits_weights_1; // @[TreePE.scala 156:22]
  assign pes_1_pe_io_mem_dataOut_1 = brams_1_io_dataOut_1; // @[TreePEsWrapper.scala 65:40]
  assign pes_1_pe_io_sample_out_ready = last_interconnect_io_sample_in_ready; // @[TreePE.scala 152:22]
  assign brams_0_clock = clock;
  assign brams_0_io_addr_1 = pes_0_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 63:32]
  assign brams_0_io_enable_2 = brams_io_0_enable_2; // @[TreePEsWrapper.scala 67:34]
  assign brams_0_io_write_2 = brams_io_0_write_2; // @[TreePEsWrapper.scala 68:33]
  assign brams_0_io_addr_2 = brams_io_0_addr_2; // @[TreePEsWrapper.scala 69:32]
  assign brams_0_io_dataIn_2 = brams_io_0_dataIn_2; // @[TreePEsWrapper.scala 70:34]
  assign brams_1_clock = clock;
  assign brams_1_io_addr_1 = pes_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 63:32]
  assign brams_1_io_enable_2 = brams_io_1_enable_2; // @[TreePEsWrapper.scala 67:34]
  assign brams_1_io_write_2 = brams_io_1_write_2; // @[TreePEsWrapper.scala 68:33]
  assign brams_1_io_addr_2 = brams_io_1_addr_2; // @[TreePEsWrapper.scala 69:32]
  assign brams_1_io_dataIn_2 = brams_io_1_dataIn_2; // @[TreePEsWrapper.scala 70:34]
  ...
  assign first_interconnects_0_io_sample_looping_valid = increment_io_sample_out_valid; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_features_0 = increment_io_sample_out_bits_features_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_features_1 = increment_io_sample_out_bits_features_1; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_features_2 = increment_io_sample_out_bits_features_2; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_features_3 = increment_io_sample_out_bits_features_3; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_offset = increment_io_sample_out_bits_offset; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_search_for_root = increment_io_sample_out_bits_search_for_root; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_tree_to_exec = increment_io_sample_out_bits_tree_to_exec; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_scores_0 = increment_io_sample_out_bits_scores_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_scores_1 = increment_io_sample_out_bits_scores_1; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_scores_2 = increment_io_sample_out_bits_scores_2; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_scores_3 = increment_io_sample_out_bits_scores_3; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_weights_0 = increment_io_sample_out_bits_weights_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_0_io_sample_looping_bits_weights_1 = increment_io_sample_out_bits_weights_1; // @[IncrementTreePE.scala 29:23]
  ...
  assign last_interconnect_io_sample_in_valid = pes_1_pe_io_sample_out_valid; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_features_0 = pes_1_pe_io_sample_out_bits_features_0; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_features_1 = pes_1_pe_io_sample_out_bits_features_1; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_features_2 = pes_1_pe_io_sample_out_bits_features_2; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_features_3 = pes_1_pe_io_sample_out_bits_features_3; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_offset = pes_1_pe_io_sample_out_bits_offset; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_search_for_root = pes_1_pe_io_sample_out_bits_search_for_root; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_tree_to_exec = pes_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_scores_0 = pes_1_pe_io_sample_out_bits_scores_0; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_scores_1 = pes_1_pe_io_sample_out_bits_scores_1; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_scores_2 = pes_1_pe_io_sample_out_bits_scores_2; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_scores_3 = pes_1_pe_io_sample_out_bits_scores_3; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_weights_0 = pes_1_pe_io_sample_out_bits_weights_0; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_weights_1 = pes_1_pe_io_sample_out_bits_weights_1; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_in_bits_dest = pes_1_pe_io_sample_out_bits_dest; // @[TreePE.scala 152:22]
  assign last_interconnect_io_sample_looping_ready = increment_io_sample_in_ready; // @[Interconnect.scala 34:27]
  assign last_interconnect_io_sample_leaving_ready = wrapper_io_sample_out_0_ready; // @[TreePEsWrapper.scala 89:45]
  ...
  assign increment_io_sample_out_ready = first_interconnects_0_io_sample_looping_ready; // @[IncrementTreePE.scala 29:23]
  ...
  assign pes_0_1_pe_io_mem_dataOut_1 = brams_0_1_io_dataOut_1; // @[TreePEsWrapper.scala 65:40]
  assign pes_0_1_pe_io_sample_out_ready = pes_1_1_pe_io_sample_in_ready; // @[TreePE.scala 156:22]
  assign pes_1_1_clock = clock;
  assign pes_1_1_reset = reset;
  assign pes_1_1_pe_io_sample_in_valid = pes_0_1_pe_io_sample_out_valid; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_features_0 = pes_0_1_pe_io_sample_out_bits_features_0; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_features_1 = pes_0_1_pe_io_sample_out_bits_features_1; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_features_2 = pes_0_1_pe_io_sample_out_bits_features_2; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_features_3 = pes_0_1_pe_io_sample_out_bits_features_3; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_offset = pes_0_1_pe_io_sample_out_bits_offset; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_search_for_root = pes_0_1_pe_io_sample_out_bits_search_for_root; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_tree_to_exec = pes_0_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_scores_0 = pes_0_1_pe_io_sample_out_bits_scores_0; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_scores_1 = pes_0_1_pe_io_sample_out_bits_scores_1; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_scores_2 = pes_0_1_pe_io_sample_out_bits_scores_2; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_scores_3 = pes_0_1_pe_io_sample_out_bits_scores_3; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_weights_0 = pes_0_1_pe_io_sample_out_bits_weights_0; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_sample_in_bits_weights_1 = pes_0_1_pe_io_sample_out_bits_weights_1; // @[TreePE.scala 156:22]
  assign pes_1_1_pe_io_mem_dataOut_1 = brams_1_1_io_dataOut_1; // @[TreePEsWrapper.scala 65:40]
  assign pes_1_1_pe_io_sample_out_ready = last_interconnect_1_io_sample_in_ready; // @[TreePE.scala 152:22]
  assign brams_0_1_clock = clock;
  assign brams_0_1_io_addr_1 = pes_0_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 63:32]
  assign brams_0_1_io_enable_2 = brams_io_2_enable_2; // @[TreePEsWrapper.scala 67:34]
  assign brams_0_1_io_write_2 = brams_io_2_write_2; // @[TreePEsWrapper.scala 68:33]
  assign brams_0_1_io_addr_2 = brams_io_2_addr_2; // @[TreePEsWrapper.scala 69:32]
  assign brams_0_1_io_dataIn_2 = brams_io_2_dataIn_2; // @[TreePEsWrapper.scala 70:34]
  assign brams_1_1_clock = clock;
  assign brams_1_1_io_addr_1 = pes_1_1_pe_io_mem_addr_1; // @[TreePEsWrapper.scala 63:32]
  assign brams_1_1_io_enable_2 = brams_io_3_enable_2; // @[TreePEsWrapper.scala 67:34]
  assign brams_1_1_io_write_2 = brams_io_3_write_2; // @[TreePEsWrapper.scala 68:33]
  assign brams_1_1_io_addr_2 = brams_io_3_addr_2; // @[TreePEsWrapper.scala 69:32]
  assign brams_1_1_io_dataIn_2 = brams_io_3_dataIn_2; // @[TreePEsWrapper.scala 70:34]
  ...
  assign first_interconnects_1_io_sample_looping_valid = increment_1_io_sample_out_valid; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_features_0 = increment_1_io_sample_out_bits_features_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_features_1 = increment_1_io_sample_out_bits_features_1; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_features_2 = increment_1_io_sample_out_bits_features_2; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_features_3 = increment_1_io_sample_out_bits_features_3; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_offset = increment_1_io_sample_out_bits_offset; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_search_for_root = increment_1_io_sample_out_bits_search_for_root; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_tree_to_exec = increment_1_io_sample_out_bits_tree_to_exec; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_scores_0 = increment_1_io_sample_out_bits_scores_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_scores_1 = increment_1_io_sample_out_bits_scores_1; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_scores_2 = increment_1_io_sample_out_bits_scores_2; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_scores_3 = increment_1_io_sample_out_bits_scores_3; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_weights_0 = increment_1_io_sample_out_bits_weights_0; // @[IncrementTreePE.scala 29:23]
  assign first_interconnects_1_io_sample_looping_bits_weights_1 = increment_1_io_sample_out_bits_weights_1; // @[IncrementTreePE.scala 29:23]
  ...
  assign last_interconnect_1_io_sample_in_valid = pes_1_1_pe_io_sample_out_valid; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_features_0 = pes_1_1_pe_io_sample_out_bits_features_0; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_features_1 = pes_1_1_pe_io_sample_out_bits_features_1; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_features_2 = pes_1_1_pe_io_sample_out_bits_features_2; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_features_3 = pes_1_1_pe_io_sample_out_bits_features_3; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_offset = pes_1_1_pe_io_sample_out_bits_offset; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_search_for_root = pes_1_1_pe_io_sample_out_bits_search_for_root; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_tree_to_exec = pes_1_1_pe_io_sample_out_bits_tree_to_exec; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_scores_0 = pes_1_1_pe_io_sample_out_bits_scores_0; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_scores_1 = pes_1_1_pe_io_sample_out_bits_scores_1; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_scores_2 = pes_1_1_pe_io_sample_out_bits_scores_2; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_scores_3 = pes_1_1_pe_io_sample_out_bits_scores_3; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_weights_0 = pes_1_1_pe_io_sample_out_bits_weights_0; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_weights_1 = pes_1_1_pe_io_sample_out_bits_weights_1; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_in_bits_dest = pes_1_1_pe_io_sample_out_bits_dest; // @[TreePE.scala 152:22]
  assign last_interconnect_1_io_sample_looping_ready = increment_1_io_sample_in_ready; // @[Interconnect.scala 34:27]
  assign last_interconnect_1_io_sample_leaving_ready = wrapper_io_sample_out_1_ready; // @[TreePEsWrapper.scala 89:45]
  ...
  assign increment_1_io_sample_out_ready = first_interconnects_1_io_sample_looping_ready; // @[IncrementTreePE.scala 29:23]
endmodule
