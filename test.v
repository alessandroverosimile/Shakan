...
module BRAMBlackBoxAsymm(
  ...
  wire  bram_1_clk; // @[ME.scala 201:24]
  wire  bram_1_a_wr; // @[ME.scala 201:24]
  wire [10:0] bram_1_a_addr; // @[ME.scala 201:24]
  wire [31:0] bram_1_a_din; // @[ME.scala 201:24]
  wire [31:0] bram_1_a_dout; // @[ME.scala 201:24]
  wire  bram_1_b_wr; // @[ME.scala 201:24]
  wire [10:0] bram_1_b_addr; // @[ME.scala 201:24]
  wire [31:0] bram_1_b_din; // @[ME.scala 201:24]
  wire [31:0] bram_1_b_dout; // @[ME.scala 201:24]
  wire [11:0] _bram_1_io_a_addr_T_1 = {io_b_addr, 1'h0}; // @[ME.scala 204:67]
  wire [11:0] _bram_1_io_a_addr_T_2 = io_a_en ? {{1'd0}, io_a_addr[12:2]} : _bram_1_io_a_addr_T_1; // @[ME.scala 204:28]
  wire [11:0] _bram_1_io_b_addr_T_2 = _bram_1_io_a_addr_T_1 + 12'h1; // @[ME.scala 208:42]
  BRAMBlackBoxSingle #(.DATA(32), .ADDR(11)) bram_1 ( // @[ME.scala 201:24]
    .clk(bram_1_clk),
    .a_wr(bram_1_a_wr),
  ...
  assign io_a_dout = bram_1_a_dout; // @[ME.scala 210:15]
  assign io_b_dout = {bram_1_b_dout,bram_1_a_dout}; // @[Cat.scala 33:92]
  assign bram_1_clk = io_clk; // @[ME.scala 211:19]
  assign bram_1_a_wr = io_a_en & io_a_wr; // @[ME.scala 203:26]
  assign bram_1_a_addr = _bram_1_io_a_addr_T_2[10:0]; // @[ME.scala 204:22]
  assign bram_1_a_din = io_a_en ? io_a_din : 32'h0; // @[ME.scala 205:27]
  assign bram_1_b_wr = 1'h0; // @[ME.scala 207:26]
  assign bram_1_b_addr = _bram_1_io_b_addr_T_2[10:0]; // @[ME.scala 208:22]
  assign bram_1_b_din = 32'h0; // @[ME.scala 209:32]
endmodule
module RRArbiter(
  input         clock,
