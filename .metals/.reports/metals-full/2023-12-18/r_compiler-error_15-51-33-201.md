...
class TreePEsWrapper(n_trees: Int, max_depth: Int, n_attr: Int, n_classes: Int, n_depths: Int, info_bit: Int, tree_bit: Int, attr_bit: Int, bram_size: Int = 36864, structure_list: List[List[Int]], synthesis: Boolean = false) extends Module{
    ...
    */
    ...
    if (synthesis){
        ...
        forward_converter.io.sample_out <> first_interconnects(0).io.sample_entering //dispatcher.io.sample_in
    ...
    */
    ...
    for(i@@)
    first_interconnect.io.sample_looping.bits.features := 5.U
    ...
    first_interconnect.io.sample_looping.bits.weights := 5.U
    first_interconnect.io.sample_looping.bits.scores := 5.U
